                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a data-scroll href="DoctorLogin.jsp">Doctor</a></li>
                           <li><a data-scroll href="TA.jsp">TA</a></li>
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <img src="images/icon-logo.png" alt="#" /></span></span>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time one" style="background:#2895f1;">
                     ...
                     <img src="images/doctor_03.jpg" alt="" class="img-responsive img-rounded"><!--  <h3>Emergency Case</h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time three" style="background:#0060b1;">
                     ...
                     <img src="images/doctor_01.jpg" alt="" class="img-responsive img-rounded"> <!-- <h3>Clinic Timetable</h3>
                     <p>Dignissimos ducimus qui blanditii sentium volta tum deleniti atque cori as quos dolores et quas mole.</p> -->
                  </div>
               </div>
            </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-6">
                 <form action="PatientLoginCheck.jsp" method="post" id="" >
...
<tr>
  ...
  <td width="218px"><input type="password" id="password" name="password" class="text" required="" /></td>
</tr>
...
<tr>
  ...
  <td align="left" valign="middle"> <p>&nbsp;
    ...
    <div align="right">
        ...
        </form> <h1><a href="patientreg.jsp">Register</a></h1>
         </div>
         </div>
         </div>
         </div>
