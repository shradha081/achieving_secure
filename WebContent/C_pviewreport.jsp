...
<%-- <%@page import="com.minds.bean.PUploadreport"%> --%>
				...
				<nav class="main-menu">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li><a data-scroll href="Doctordetails.jsp">Doctor
									Details</a></li>
							<li><a class="active" data-scroll href="C_pviewreport.jsp">Patient
									Report</a></li>
