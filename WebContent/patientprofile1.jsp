               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        <li><a data-scroll href="patienthome.jsp">Home</a></li>
                        <li><a class="active" href="patientprofile.jsp">View Particular Details</a></li>
...
<br>
<br>	<div class="table-responsive-xl table-responsive-sm table-responsive-md table-responsive-lg">
...
<tr>
	...
	<th class="labelName">content </th>
	<th class="labelName"><%=rs.getBlob("content")%></th>

</tr> --%><tr>
	<th class="labelName">Time </th>
	<th class="labelName"><%=rs.getString("time")%></th>

</tr>
 <tr>
	<th class="labelName">secret key </th>
	<th class="labelName"><%=rs.getString("secret_key")%></th>

</tr> 
 <tr>
	<th class="labelName">status </th>
	<th class="labelName"><%=rs.getString("status")%></th>

</tr>
 <tr>
	<th class="labelName">epname </th>
	<th class="labelName"><%=rs.getString("epname")%></th>

</tr>
 <tr>
	<th class="labelName">eemail </th>
	<th class="labelName"><%=rs.getString("eemail")%></th>

</tr>
 <tr>
	<th class="labelName">eattributekey </th>
	<th class="labelName"><%=rs.getString("eattributekey")%></th>
...
<th class="labelName"><%=rs.getString("id")%></th>
	...
	<th class="labelName">Name: </th>
	<th class="labelName"><%=rs.getString("name")%></th>
