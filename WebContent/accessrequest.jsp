				...
				<nav class="main-menu">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li><a data-scroll href="SearchKeyword.jsp"> search
									keyword</a></li>
						...
						<div class="w3-top">
							...
							<div class="row content">
								...
								<div class="col-sm-12 text-left">
									<CENTER><b><h2>Access Request</h2></b></CENTER>
									<form class="form-horizontal" action="login.jsp">
										<div class="form-group">
											<label class="control-label col-sm-4" for="secretkey">Enter
												secret_key:</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" id="secretkey"
													placeholder="Enter secret_key" name="secret_key" required>
											</div>
										</div>
